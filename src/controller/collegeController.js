const collegeModel = require("../model/collegeModel");
 const {isValidFullName,isValid,isValidlogoLink} = require("../validation/validator");
...
try {
    ...
    return res.status(400).send({ status: false, msg: "Pls Enter Valid Name in small case" })
